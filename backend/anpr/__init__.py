            ...
            for track_id, track_data in self.tracks.items():
                ...
                for idx, (cx, cy, det) in enumerate(current_centroids):
                    ...
                    if last_centroids:
                        ...
                        if (
                            distance < best_distance and distance < 150
                ...
                if best_match_idx >= 0:
                    ...
                    if "plate" in det and det["plate"]:
                        ...
                        self.tracks[track_id]["plate_confidence"] = det.get(
                            "plate_confidence", 0
                        )
                    ...
                    active_tracks.append(
                        {
                            ...
                            "last_seen": (
                                track_data["last_seen"].isoformat()
...
class ANPRSystem:
    ...
    def __init__(self, config: Dict = None):
        ...
        self.ocr = PlateOCR(languages=self.config.get("languages", ["en"]))
    ...
    def _update_stats(self, start_time: float, detections: List, tracks: List):
        ...
        if len(self.frame_times) > 1:
            ...
            self.stats["fps"] = (
                len(self.frame_times) / time_diff if time_diff > 0 else 0
            )
    ...
    def get_frame_with_overlay(self) -> Tuple[np.ndarray, Dict]:
        ...
        with self.lock:
            ...
            return self.latest_frame.copy(), (
                self.latest_result.copy() if self.latest_result else {}
            )
