...
class RiskEngine:
    ...
    def _calculate_spatial_risk(self, location: str, coordinates: Optional[Dict[str, float]]) -> float:
    ...
    def _calculate_historical_risk(self, location: str, coordinates: Optional[Dict[str, float]]) -> float:
