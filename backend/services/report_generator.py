...
class ReportGenerator:
    ...
    def generate_all_counties_report(
        self, report_type: str = "executive", period: str = "month"
    ) -> Dict:
        reports = []
    ...
    def _generate_infrastructure(self, county_name: str, period: str) -> Dict:
        ...
        return {
            ...
            "recommendations": self._generate_infrastructure_recommendations(
                county_infra[0] if county_infra else {}
            ),
        }
    ...
    def _generate_weather_impact(self, county_name: str, period: str) -> Dict:
        ...
        return {
            ...
            "recommendations": self._get_weather_recommendations(
                county_weather[0] if county_weather else {}
            ),
        }
    ...
    def _generate_traffic(self, county_name: str, period: str) -> Dict:
        ...
        return {
            ...
            "recommendations": self._get_traffic_recommendations(
                county_congestion[0] if county_congestion else {}
            ),
        }
    ...
    def _generate_recommendations(self, risk_score: float, trend: str) -> List[str]:
        ...
        if risk_score >= 70:
            recommendations.append(
                "URGENT: Immediate intervention required. Consider road safety audit."
            )
            recommendations.append("Increase enforcement presence in high-risk areas.")
        elif risk_score >= 50:
            recommendations.append(
                "Implement targeted safety improvements in accident-prone areas."
            )
