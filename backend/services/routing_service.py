...
class RoutingService:
    ...
    def __init__(self, osrm_url: str = "http://router.project-osrm.org"):
        ...
        self.cache: Dict[Tuple[float, float, float, float], Tuple[RouteResult, datetime]] = {}
    ...
    async def get_route(
        ...
        if self.use_osrm:
            try:
                return await self._osrm_route(start_lng, start_lat, end_lng, end_lat, profile)
